'''Desafio para fazer um jogo de pedra papel e tesoura. Com entrada para dois jogadores e três rodadas. Caso um jogador ganhe duas partidas não precisa fazer a terceira. Já encerra mostrando
...
for c in range(0,3,1):
    ...
    #condição para parar  na segunda rodada caso um jogador ganhe a primeira e a segunda rodada
